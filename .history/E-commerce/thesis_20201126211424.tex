...
\begin{titlepage}
    \begin{center}
        ...
        \begin{tabular}{cc}
            \normalsize \kaishu{学年学期：}&
            \normalsize {\dlmu[10cm]{2020——2021学年第一学期}}\vspace{12pt}\\
            \normalsize \kaishu{课程名称：}&
            \normalsize {\dlmu[10cm]{电子商务概论}}\vspace{12pt}\\
            \normalsize \kaishu{课程代码：}&
            \normalsize {\dlmu[10cm]{}}\vspace{12pt}\\
            \normalsize \kaishu{任课教师：}&
            \normalsize {\dlmu[10cm]{涂艳}}\vspace{12pt}\\
            \normalsize \kaishu{姓 \qquad   名：}&
            \normalsize {\dlmu[10cm]{赵之航}}\vspace{12pt}\\
            \normalsize \kaishu{学 \qquad   号：}&
            \normalsize {\dlmu[10cm]{20183311178}}\vspace{12pt}\\
            \normalsize \kaishu{班  \qquad  级：}&
            \normalsize {\dlmu[10cm]{国民经济管理18}}\vspace{40pt}\\

            \normalsize \kaishu{总 \qquad   分：}&
            \normalsize {\dlmu[10cm]{}}\vspace{12pt}\\
            \normalsize \kaishu{评 \hfill 分 \hfill 人：}&
            \normalsize {\dlmu[10cm]{}}
        \end{tabular}
...
Then we returned to the domestic market to observe and analyze similar domestic manufacturers, explore the impact of Netflix on them and the localization improvements made by domestic manufacturers.
