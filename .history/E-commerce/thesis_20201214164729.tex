...
码率，而画面更复杂（例如动作戏、追车戏、爆炸场面）的部分则分配更高的码率。不同类型的作品也会有不同的算法来进行优化。动态优化器在不降低画面质量的前提下，大大缩小了视频的体积，可为用户节省约20％的带宽\upcite{6195531}。
...
下面对用户可感知的Netflix推荐系统做简单介绍\upcite{10.1145/2843948}：
\begin{enumerate}
    \item 个人影片推荐（PVR）\par 
