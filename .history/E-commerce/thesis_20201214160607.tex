...
\begin{enumerate}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.55\textwidth]{PVR}
        \caption{个人影片推荐}
    \end{figure}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.6\textwidth]{trending}
        \caption{现正热播}
    \end{figure}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.6\textwidth]{topn}
        \caption{榜单}
    \end{figure}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.6\textwidth]{similar}
        \caption{类似影片}
    \end{figure}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.6\textwidth]{continue}
        \caption{继续观看}
    \end{figure}
\end{enumerate}
